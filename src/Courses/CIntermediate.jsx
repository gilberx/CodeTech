        ...
        <div style={{marginTop:'130px', display:'flex', justifyContent:'center', alignItems:'center'}}>
          ...
          borderRadius:'15px', paddingTop:'20px'}}>
            ...
            <div style={{maxWidth:'70%', paddingLeft:'20px'}}>
              ...
              <p style={{fontFamily:'Montserrat, sans-serif', fontSize:'15px', paddingTop:'10px'}}>Intermediate C programming builds on the basics of 
              the language to cover more complex topics, data structures, and memory management. 
              This enables programmers to write more efficient and powerful code.</p>
            </div>  
          </Paper>
        </div>
        {isCourseTaken ? (
