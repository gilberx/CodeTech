        ...
        <div style={{marginTop:'130px', display:'flex', justifyContent:'center', alignItems:'center'}}>
          ...
          borderRadius:'15px', paddingTop:'20px'}}>
            ...
            <div style={{maxWidth:'70%', paddingLeft:'20px'}}>
              ...
              <p style={{fontFamily:'Montserrat, sans-serif', fontSize:'15px', paddingTop:'10px'}}>Intermediate C# programming builds on the basics of the 
              language to cover more advanced topics, such as generics, LINQ, async/await, and 
              design patterns, enabling programmers to write more complex and efficient code.</p>
            </div>  
          </Paper>
        </div>
        {isCourseTaken ? (
