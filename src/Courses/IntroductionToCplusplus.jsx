    ...
    <div class='introC'>
      ...
      <div style={{marginTop:'130px', display:'flex', justifyContent:'center', alignItems:'center'}}>
        ...
        borderRadius:'15px', paddingTop:'20px'}}>
          <div style={{maxWidth:'25%', paddingTop:'15px', marginLeft:'-20px'}}>
            <img src="/17.png" style={{height:'110px'}}/>
          </div>
          <div style={{maxWidth:'70%', paddingLeft:'20px'}}>
            ...
            <p style={{fontFamily:'Montserrat, sans-serif', fontSize:'15px', paddingTop:'10px'}}>C++ is a general-purpose programming language that
             supports multiple paradigms, including object-oriented
             and generic programming, and is used to develop a wide 
      ...
      marginTop:'50px'}}>
        <button class='buttoncontainer' onClick={toggleDrawer1}>
          ...
          Basic Concepts
          <img src='./dropdownlogo.png' style={{height:'30px', marginLeft:'154px'}}/>
        </button>
        {isDrawerOpen1 && (
          <div>
      ...
      flexDirection:'column'}}>
        <button class='buttoncontainer' onClick={toggleDrawer3}>
          <img src='./topiclogo.png' style={{height:'35px', marginLeft:'-10px'}}/>
          Array & Pointers
          <img src='./dropdownlogo.png' style={{height:'30px', marginLeft:'148px'}}/>
        </button>
        {isDrawerOpen3 && (
          <div>
          <Paper class='papercontainer'>
      ...
      <button class='buttoncontainer' onClick={toggleDrawer4}>
          <img src='./topiclogo.png' style={{height:'35px', marginLeft:'-10px'}}/>
          Functions
          <img src='./dropdownlogo.png' style={{height:'30px', marginLeft:'208px'}}/>
        </button>
        {isDrawerOpen4 && (
          <div>
          <Paper class='papercontainer'>
      ...
      <div style={{display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column'}}>
        <button class='buttoncontainer' onClick={toggleDrawer6} style={{color:"red", fontWeight:'600'}}>
            <img src='./topiclogo.png' style={{height:'35px', marginLeft:'-10px'}}/>
            Final Exam
            <img src='./dropdownlogo.png' style={{height:'30px', marginLeft:'188px'}}/>
        </button>
        {isDrawerOpen6 && (
          <div>
          <Paper class='papercontainer'>
